layui.use(['table', 'layer'], function () {
    ...
    var tableIns = table.render({
        ...
        // {templet:"<div>{{layui.util.toDateString(d.createDate,'yyyy-MM-dd HH:mm:ss')}}</div>", title: '创建时间'},
        // 时间格式化，可以在前端这样改，也可以在实体类上加@JsonFormat注解
        cols: [[
    ...
    function formatterDevResult(value) {
         ...
         */
        if (value == 0) {
            return "<div style='color: #007DDB'>未开发</div>";
        } else if (value == 1) {
